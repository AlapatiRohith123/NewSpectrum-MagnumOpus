        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          ...
          <ul className="navbar-nav ml-auto">
            ...
            <li className="nav-item">
              <a className="nav-link" href="/Entrepreneur">Home</a>
            </li>
            <li className="nav-item">
              <a className="nav-link" href="Post_problem">Post problem</a>
            </li>
            <li className="nav-item dropdown" style={{position: "relative"}}>
              ...
              <div className="dropdown-menu profiledropdown" aria-labelledby="profileDropdown">
                ...
                <a className="dropdown-item" href="My_problems">My Problems</a>
